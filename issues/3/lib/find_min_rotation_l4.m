function [R,fval,exitflag] = find_min_rotation_l4(Lambda)
% find rotations of Lambda with largest l4-norm across grid of starting
% points
[~,r]=size(Lambda);
no_draws      = gridsize(r); 
...
parfor rep=1:no_draws
        ...
        fun2=@(theta) objectivefcn_spherical_l4(theta,Lambda);
